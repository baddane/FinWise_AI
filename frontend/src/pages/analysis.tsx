    ...
    <div className="flex min-h-screen bg-surface-50">
      ...
      <main className="ml-[260px] flex-1 p-8 max-w-[1200px]">
        <div className="mb-8 animate-fade-in">
          <h1 className="text-2xl font-bold text-surface-900">Analysis</h1>
          <p className="text-sm text-surface-400 mt-1">Deep dive into your financial data</p>
        </div>

        {isDataLoading ? (
          <div className="card p-12 text-center text-surface-400 text-sm">Loading data…</div>
        ) : (
          <>
            ...
            <div className="card p-6 animate-slide-up">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h3 className="text-sm font-semibold text-surface-900">AI Financial Insights</h3>
                  <p className="text-xs text-surface-400 mt-0.5">Powered by Claude</p>
                </div>
                <button
              ...
              {insights ? (
                ...
                <p className="text-surface-400 text-sm">
                  Click &quot;Generate Insights&quot; to get AI-powered analysis of your spending patterns and personalized recommendations.
                </p>
              )}
            </div>
          </>
